...
static int std_fread(RLEstate *rleInfo, void *buf, size_t datasize, size_t nelems, FILE *fp)
{
  if (verbose > 1) {
...
static int rle_fread(RLEstate *rleInfo, void *vbuf, int datasize, int nelems, FILE *fp)
{
...
gliGenericImage *gliReadTGA(FILE *fp, char *name)
{
  TgaHeader tgaHeader;
  TgaFooter tgaFooter;
